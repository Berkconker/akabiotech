...
const DNAAnimation = () => {
  ...
  // Build smooth SVG path for each strand
  ...
  return (
    <svg
      ...
      style={{ filter: "drop-shadow(0 0 30px rgba(45,122,79,0.25))" }}
    >
      <defs>
        <linearGradient id="strand-grad" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#4a9e6b" stopOpacity="0.9" />
          <stop offset="50%" stopColor="#2d7a4f" stopOpacity="1" />
        ...
        return (
          ...
          >
            ...
            <motion.circle
              ...
              cy={p.y}
              r={r1}
              fill={p.depth > 0.5 ? "#2d7a4f" : "#4a9e6b"}
              filter="url(#glow)"
              animate={{
                r: [r1, r1 + 1.5, r1],
            ...
            <motion.circle
              ...
              cy={p.y}
              r={r2}
              fill={p.depth > 0.5 ? "#1a3a2a" : "#2d7a4f"}
              filter="url(#glow)"
              animate={{
                r: [r2, r2 + 1.5, r2],
                opacity: [opacity, 1, opacity],
...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen bg-[#1a3a2a] overflow-hidden flex items-center"
    >
      {/* Background pattern */}
      <div
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#2d7a4f]/20 to-transparent pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#2d7a4f]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-8">
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2 bg-[#2d7a4f]/20 border border-[#2d7a4f]/40 rounded-full px-4 py-2 w-fit"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
              <FlaskConical size={14} className="text-[#7dd4a8]" />
              <span className="font-sans text-sm text-[#7dd4a8] font-medium tracking-wide">
                {lang === "tr"
                  ? "Biyoteknoloji Ar-Ge Merkezi"
            ...
            >
              {t.headline}
              <br />
              <span className="text-[#7dd4a8]">{t.headlineAccent}</span>
            </motion.h1>
            ...
            >
              <a
                href="#research"
                className="inline-flex items-center justify-center gap-2 bg-[#2d7a4f] hover:bg-[#3d9a6a] text-white font-sans font-medium px-7 py-3.5 rounded-full transition-all duration-300 hover:gap-3 group"
              >
                {t.cta1}
                <ArrowRight
                  size={16}
            ...
            >
              {t.stats.map((stat, i) => (
                <div key={i} className="flex flex-col gap-1">
                  <span className="font-serif text-3xl sm:text-4xl text-[#7dd4a8] font-bold">
                    {stat.value}
                  </span>
